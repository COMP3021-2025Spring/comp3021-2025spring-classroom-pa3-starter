...
public class GPT4ominiClient extends ChatClient {
     ...
     */
    @JsonCheck
    static final String apiURL = "https://hkust.azure-api.net/openai/deployments/gpt-4o-mini/chat/completions?api-version" +
            "=2024-06-01";
     ...
     */
    public GPT4ominiClient(JSONObject session) throws PersistenceException {
        super(session);
    }
}
